...
func newMenu(db *gorm.DB, opts ...gen.DOOption) menu {
	...
	_menu.MenuID = field.NewInt64(tableName, "menu_id")
	_menu.Pid = field.NewInt64(tableName, "pid")
	_menu.Name = field.NewString(tableName, "name")
	_menu.Code = field.NewString(tableName, "code")
	_menu.ToCode = field.NewString(tableName, "to_code")
	_menu.Type = field.NewInt32(tableName, "type")
...
type menu struct {
	...
	Code       field.String
	ToCode     field.String
	Type       field.Int32 // 菜单类型（1=目录，2=菜单/按钮，0=其它）
	Status     field.Bool  // 菜单状态（true=启用，false=禁用），默认启用
	Level      field.Int32 // 菜单层级（1=一级，2=二级，3=三级，4=按钮）
...
func (m *menu) updateTableName(table string) *menu {
	...
	m.ToCode = field.NewString(table, "to_code")
