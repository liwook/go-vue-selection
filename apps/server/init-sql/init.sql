...
(14,8,'分配角色','btn.User.assgin','',2,4),
(9,7,'角色管理','Role','',1,3),
(15,9,'分配权限','btn.Role.assgin','RoleAuth',2,4),
...
(45,23,'修改分类','btn.Category.update','',2,4),
(46,23,'删除分类','btn.Category.remove','',2,4),
...
(57,26,'删除Spu','btn.Spu.delete','',2,4),
(27,22,'Sku管理','Sku','',1,3),
(58,27,'Sku上下架','btn.Sku.updown','',2,4),
...
(14988,33,'活动监督','btn.Activity.jiandu','',0,4),
...
(1,1),(1,7),(1,8),(1,11),(1,12),(1,13),(1,14),(1,9),(1,15),(1,16),(1,17),(1,18),(1,10),(1,19),(1,20),(1,21),(1,22),(1,23),(1,44),(1,45),(1,46),(1,24),(1,50),(1,51),(1,52),(1,25),(1,47),(1,48),(1,49),(1,13146),(1,26),(1,53),(1,54),(1,55),(1,56),(1,57),(1,27),(1,58),(1,59),(1,60),(1,61),(1,28),(1,29),(1,41),(1,42),(1,62),(1,30),(1,31),(1,43),(1,32),(1,33),(1,35),(1,36),(1,37),(1,14988),(1,34),(1,38),(1,39),(1,40),(1,15804),(1,100),
-- 普通用户(role 2)：商品管理相关模块 + 各级 CRUD 菜单
-- 注意：menu 表中不存在 menu_id 2~6，原数据引用了这些不存在的 id 会导致外键约束失败，
-- 此处将根菜单映射为真实存在的 menu_id=22（商品管理）。
(2,22),(2,7),(2,8),(2,9),(2,10),(2,11),(2,12),(2,13),(2,14),(2,15),(2,16),(2,17),(2,18),(2,19),(2,20),(2,21),(2,23),(2,24),(2,25),(2,26),(2,27),(2,28),(2,29),(2,30),(2,31),(2,32),(2,33),(2,34),(2,35),(2,36),(2,37),(2,38),(2,39),(2,40),(2,41),(2,42),(2,43),(2,44),(2,45),(2,46),(2,47),(2,48),(2,49),(2,50),(2,51),(2,52),(2,53),(2,54),(2,55),(2,56),(2,57),(2,58),(2,59),(2,60),(2,61),(2,13146),(2,14988),(2,15804),(2,100),
-- 游客(role 3)
-- 同上，menu_id=2 不存在，映射为 22（商品管理）。
(3,22),(3,18),(3,23),(3,26),(3,31),(3,36),(3,41),(3,44),(3,46),(3,47),(3,52);
