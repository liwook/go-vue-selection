...
(1,1),(1,7),(1,8),(1,11),(1,12),(1,13),(1,9),(1,16),(1,17),(1,18),(1,10),(1,19),(1,20),(1,21),(1,22),(1,23),(1,44),(1,45),(1,46),(1,24),(1,50),(1,51),(1,52),(1,25),(1,47),(1,48),(1,49),(1,13146),(1,26),(1,53),(1,54),(1,55),(1,56),(1,57),(1,27),(1,58),(1,15805),(1,59),(1,60),(1,61),(1,28),(1,29),(1,41),(1,42),(1,62),(1,30),(1,31),(1,43),(1,32),(1,33),(1,35),(1,36),(1,37),(1,14988),(1,34),(1,38),(1,39),(1,40),(1,15804),(1,100),
-- 普通用户(role 2)：商品管理相关模块 + 各级 CRUD 菜单
-- 注意：menu 表中不存在 menu_id 2~6，原数据引用了这些不存在的 id 会导致外键约束失败，
-- 此处将根菜单映射为真实存在的 menu_id=22（商品管理）。
(2,22),(2,23),(2,44),(2,45),(2,46),(2,24),(2,50),(2,51),(2,52),(2,25),(2,47),(2,48),(2,49),(2,13146),(2,26),(2,53),(2,54),(2,55),(2,56),(2,57),(2,27),(2,58),(2,15805),(2,59),(2,60),(2,61),
-- 游客(role 3)
